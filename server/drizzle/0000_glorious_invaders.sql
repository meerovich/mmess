...
CREATE INDEX "idx_cp_conversation" ON "conversation_participants" USING btree ("conversation_id");--> statement-breakpoint
CREATE INDEX "idx_cp_user" ON "conversation_participants" USING btree ("user_id");--> statement-breakpoint
