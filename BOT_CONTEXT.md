...
- Исходный блок из 4 доработок закрыт полностью; последний пункт добавил поповер по тапу на галочку с временем доставки и прочтения.
- Новый UX-fix в работе: уменьшаем стартовые рывки при открытии чата за счёт повторного использования кеша сообщений и раннего позиционирования scroll, плюс смягчаем iOS viewport/input scroll-hacks вокруг фокуса textarea.
