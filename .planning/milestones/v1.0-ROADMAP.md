...
- [x] **Phase 4: Groups & Presence** - Group administration, online/offline presence, offline delivery, browser notifications (completed 2026-04-11)
- [x] **Phase 5: File Sharing** - File and image upload/download, inline previews, drag-and-drop (completed 2026-04-11)
- [x] **Phase 6: UI & Deploy** - Responsive interface, theme toggle, conversation search, production Docker deployment (completed 2026-04-11)
...
- [x] 04-05-PLAN.md — ConversationItem real presence dot + NotificationBanner + browser notification fire logic
...
- [x] 05-05-PLAN.md — MessageInput paperclip + drag-drop + upload state; MessageItem image/file rendering; Lightbox component
- [x] 05-06-PLAN.md — Avatar component extension + GroupSettingsModal admin avatar upload; human verify checkpoint
- [x] 05-07-PLAN.md — Gap closure: Enrich WS ack/broadcast and history endpoint with file metadata (file_name, file_mime, file_size, is_image, thumbnail_url)
...
- [x] 06-02-PLAN.md — ThemeToggle component (3-state segmented control) + ConversationList search + sidebar footer
- [x] 06-03-PLAN.md — Docker healthchecks (api + caddy), .env.production.example, backup/restore scripts, README deploy guide
- [x] 06-04-PLAN.md — Human UAT: theme toggle, conversation search, mobile layout, regression check (blocking checkpoint)
...
| 6. UI & Deploy | 4/4 | Complete   | 2026-04-11 |
